...
module {
  ...
  public type HolderData = {
    account : Account;
    amount : Nat;
    percentage : Float;
  };
  public type HolderListMetadata = { total : Nat64 };
  public type HolderListResp = {
  ...
  public type Self = actor {
    ...
    get_top : shared query Nat32 -> async HolderListResp;
    get_top_100_holder : shared query () -> async HolderListResp;
    get_total_holder : shared query () -> async Nat64;
