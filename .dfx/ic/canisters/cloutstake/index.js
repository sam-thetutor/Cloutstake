...
import { idlFactory } from './cloutstake.did.js';
export { idlFactory } from './cloutstake.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CLOUTSTAKE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cloutstake.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cloutstake canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cloutstake.did.js")._SERVICE>}
 */
export const cloutstake = createActor(canisterId);
